...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StatusParam.default'
        db.add_column('loki_statusparam', 'default', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Changing field 'StatusParam.val'
        db.alter_column('loki_statusparam', 'val', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True))

        # Adding field 'SchedulerParam.default'
        db.add_column('loki_schedulerparam', 'default', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'StepParam.default'
        db.add_column('loki_stepparam', 'default', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Changing field 'StepParam.val'
        db.alter_column('loki_stepparam', 'val', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True))


    def backwards(self, orm):
        
        # Deleting field 'StatusParam.default'
        db.delete_column('loki_statusparam', 'default')

        # Changing field 'StatusParam.val'
        db.alter_column('loki_statusparam', 'val', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Deleting field 'SchedulerParam.default'
        db.delete_column('loki_schedulerparam', 'default')

        # Deleting field 'StepParam.default'
        db.delete_column('loki_stepparam', 'default')

        # Changing field 'StepParam.val'
        db.alter_column('loki_stepparam', 'val', self.gf('django.db.models.fields.CharField')(max_length=200))
